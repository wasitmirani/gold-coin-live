...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './transactionsTable.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    TransitionsTable: Object(function webpackMissingModule() { var e = new Error("Cannot find module './transactionsTable.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  data: function data() {
    return {
      url: this.hosturl,
